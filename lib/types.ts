export type Nivel = "C-Level" | "Diretoria" | "Gerência Executiva" | "Gerência" | "Coordenação" | "Analista";

export type PageKey = "directors" | "executive" | "management" | "coordenacao" | "analista";
