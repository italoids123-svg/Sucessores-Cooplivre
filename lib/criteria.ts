...
export const QUESTIONS: Question[] = [
  ...
  { n: 3, title: "Localidade atual", desc: "Em qual localidade você está atuando hoje? Usada em conjunto com a resposta de mobilidade para verificar se você está ao alcance de cada posição.", natureza: "Identificação", pontos: false, resposta: "Lista das localidades cadastradas" },
  { n: 4, title: "Prioridade de interesse 1", desc: "Selecione sua principal posição de interesse.", natureza: "Qualitativo", pontos: false, resposta: "Lista das posições cadastradas" },
  { n: 5, title: "Horizonte da prioridade 1", desc: "Em quanto tempo acredita que estará pronto(a) para assumir a posição, considerando suas competências atuais e lacunas de desenvolvimento?", natureza: "Pontuação", pontos: true, resposta: "Imediato (10) · Até 3 anos (6) · Mais de 3 até 5 anos (3) · Mais de 5 anos (1,5)" },
  { n: 6, title: "Desenvolvimento para a prioridade 1", desc: "Indique até três competências, conhecimentos ou experiências que considera necessário fortalecer ou adquirir. Explique brevemente a relevância.", natureza: "Qualitativo", pontos: false, resposta: "Resposta aberta" },
  { n: 7, title: "Prioridade de interesse 2", desc: "Selecione, opcionalmente, uma segunda posição de interesse.", natureza: "Condicional", pontos: false, resposta: "Lista das posições cadastradas" },
  { n: 8, title: "Horizonte da prioridade 2", desc: "Em quanto tempo acredita que estará pronto(a) para assumir a segunda posição?", natureza: "Pontuação", pontos: true, resposta: "Imediato (10) · Até 3 anos (6) · Mais de 3 até 5 anos (3) · Mais de 5 anos (1,5)" },
  { n: 9, title: "Desenvolvimento para a prioridade 2", desc: "Indique até três competências, conhecimentos ou experiências que considera necessário fortalecer ou adquirir para a segunda posição.", natureza: "Condicional", pontos: false, resposta: "Resposta aberta" },
  { n: 10, title: "Mobilidade", desc: "Qual abrangência geográfica você aceita considerar para uma movimentação a partir da sua localidade atual? Além de pontuar, essa resposta filtra as posições para as quais você pode ser considerado(a) sucessor(a): só entram no heatmap as posições ao alcance da abrangência escolhida.", natureza: "Pontuação", pontos: true, resposta: "Local atual (0) · Sede (8) · Raio de 40 km (14) · Qualquer unidade (20)" },
  { n: 11, title: "Conversa sobre desenvolvimento", desc: "Você já teve uma conversa explícita com sua liderança sobre seu desenvolvimento ou possível preparação para alguma das posições?", natureza: "Qualitativo", pontos: false, resposta: "Sim, com ações em andamento · Sim, sem ações formalizadas · Não houve essa conversa" },
  { n: 12, title: "Continuidade da posição atual", desc: "Existe hoje algum colaborador que poderia assegurar a continuidade das principais responsabilidades de sua posição em caso de ausência ou movimentação?", natureza: "Qualitativo", pontos: false, resposta: "Sim, imediatamente · Sim, com desenvolvimento ou suporte · Não identifico alguém · Não tenho elementos para avaliar" },
  { n: 13, title: "Possível sucessor da posição atual", desc: "Caso tenha respondido sim, informe o nome completo e o cargo atual da pessoa identificada.", natureza: "Condicional", pontos: false, resposta: "Resposta curta" },
];
