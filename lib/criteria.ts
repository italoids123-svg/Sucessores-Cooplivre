...
export const QUESTIONS: Question[] = [
  ...
  { n: 9, title: "Localidade atual", desc: "Em qual localidade você está atuando hoje? Usada em conjunto com a resposta de mobilidade para verificar se você está ao alcance de cada posição.", natureza: "Identificação", pontos: false, resposta: "Lista das localidades cadastradas" },
