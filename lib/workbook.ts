...
const LEIAME_ROWS: (string[])[] = [
  ...
  ["Elegibilidade", "Para contar como sucessor no heatmap, a pessoa precisa estar no nível e na mesma diretoria elegíveis pela Hierarquia, ter a posição ao alcance da sua Mobilidade a partir da Localidade atual (mesma cidade para \"Local atual\", só Capivari para \"Sede\", até 40 km rodoviários para \"Raio de 40 km\", qualquer uma para \"Qualquer unidade\"), ter indicado a posição em Prioridade de interesse 1 ou 2, e atingir " + CRITERIA.eligibilityThreshold + " ou mais no score normalizado. A checagem de Mobilidade vale também para \"Outros interessados\": mesmo fora do nível/diretoria elegível, a pessoa só entra nessa lista para as cadeiras que estão ao alcance da sua Mobilidade."],
