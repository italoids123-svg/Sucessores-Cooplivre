...
const LEIAME_ROWS: (string[])[] = [
  ...
  ["Cadeiras", "Cada linha vira uma posição no mapa. Se o Cargo já existe, a linha é ignorada — cadeiras existentes (ocupante, nível, diretoria) só mudam por pedido direto à consultoria. Se o Cargo é novo, uma cadeira é criada; preenchendo Nome, ela já entra com ocupante, senão entra como vaga. Nível precisa ser exatamente um dos já usados no mapa (C-Level, Diretoria, Gerência Executiva, Gerência, Coordenação, Analista ou Especialista) para aparecer na navegação."],
  ...
  ["Mobilidade", "Use exatamente um destes textos: " + MOB_LABELS.join(" / ") + ". Além de pontuar, define quais posições estão ao alcance a partir da Localidade atual — ver Elegibilidade. \"Sede\" só alcança Capivari (mesmo que a Localidade atual já seja outra cidade); \"Local atual\" só alcança a própria cidade."],
  ...
  ["Elegibilidade", "Para contar como sucessor no heatmap, a pessoa precisa estar no nível elegível pela Hierarquia (a diretoria não é um critério — qualquer diretoria pode alimentar qualquer outra), ter a posição ao alcance da sua Mobilidade a partir da Localidade atual (mesma cidade para \"Local atual\", só Capivari para \"Sede\", até 40 km rodoviários para \"Raio de 40 km\", qualquer uma para \"Qualquer unidade\"), ter indicado a posição em Prioridade de interesse 1 ou 2, e atingir " + CRITERIA.eligibilityThreshold + " ou mais no score normalizado. A checagem de Mobilidade vale também para \"Interessados fora da hierarquia elegível\": mesmo fora do nível elegível, a pessoa só entra nessa lista para as cadeiras que estão ao alcance da sua Mobilidade."],
